...
!
  ...
  if ( dres >= ( 1.0d+00 - 0.5E+00 * epsilon ( resabs ) ) * resabs ) then
    ksgn = 1
  else
    ksgn = -1
  end if
...
! double precision dla
  ...
  integer numrl2
  double precision omega
  double precision, parameter :: p = 0.9E+00
  double precision, parameter :: pi = 3.1415926535897932E+00
  double precision p1
...
!
  ...
  ass = parint * sinpar
  asap = (((((2.10e+02*par2-1.0d+00)*cospar-(1.05e+02*par2 &
